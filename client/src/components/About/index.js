  ...
  return (
    <section id="about" className="about">
      ...
      <div className="content">
        <div className="col-1">
          <p>
            Hey, I’m {age} years old, from France. I’m a Front-end Developer who
            loves to combine user experiences, design and coding.
          </p>
          <p>
            My passion for web development started when I was a fundraising
            consultant for startups. I first discovered HTML and CSS when I was
            in charge of developing the company’s online presence. At that
            moment, I knew I wanted to become a web developer.
          </p>
          <p>
            After this incredible discovery, I quit my job, went to Le Wagon (a
            web developer bootcamp), learned Ruby On Rails, co-founded WorkUp, a
            non-profit organization, and developed Workup’s website on my own.
          </p>
        </div>
        <div className="col-2">
          <p>
            I have also worked on several big companies’ websites like Veolia,
            GRDF, and Hello Bank! (the online bank of BNP Paribas).
          </p>
          <p>
            I am currently working in freelance on web applications using React.
          </p>
          <p>
            If you’d like to talk about coding, foosball or anything else, feel
            free to contact me :)
          </p>
          ...
          <p>
            ...
            <a
              href="https://www.linkedin.com/in/charlottecady/?locale=en_US"
              target="_blank"
